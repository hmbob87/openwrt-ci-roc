...
# OpenList & AdGuardHome & WolPlus & Lucky & OpenAppFilter & 集客无线AC控制器 & 雅典娜LED控制 & EasyTier & luci-app-timecontrol
...
git_sparse_clone js https://github.com/gaobin89/luci-app-timecontrol.git package/luci-app-timecontrol
